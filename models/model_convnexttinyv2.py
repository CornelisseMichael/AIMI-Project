...
class ConvNextTinyV2(nn.Module):
    def __init__(self, num_classes=1, pretrained=False):  # Set pretrained=False for offline use
        super(ConvNextTinyV2, self).__init__()
        self.model = timm.create_model('convnextv2_tiny', pretrained=pretrained)
